...
- **Agent CLI (from v0.6.0-beta.2):** JSON accounts, cached mail list/search/read, owned drafts and explicitly confirmed sending; works with the app open or closed. See the [CLI guide](docs/CLI.md).
