...
- The final macOS candidate from `f2f6801` passed ad-hoc deep/strict codesign, bundle metadata/common-version checks and actual old-Node-installer upgrade/restart/backup restore. Its packaged service SHA-256 is `1bc1e1c8925f911e362ad855f0b2a9ee07c2ad0337f6a207c6c3e13eaf82d98b` (21,990,864 bytes); bundled version is `0.5.0-beta.2`. It contains the Rust service and 2,661,345 bytes of dependency notices, without a backend Node runtime. This is not Developer ID signing or notarization. Windows notices collection passed; Windows execution awaits CI.
