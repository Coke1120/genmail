...
- Native Settings visual acceptance and live provider/model acceptance remain separate from compilation/API evidence. The source changes have not been tagged or released; existing beta.2 downloads are unchanged.
